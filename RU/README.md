...
**Поздравляем** с решением принять участие в 30-дневном челендже по программированию на JavaScript. В этом задании вы изучите все, что вам нужно для того, чтобы стать программистом на JavaScript, и вообще все концепции программирования. В конце конкурса вы получите сертификат 30LessonsOfJavaScript. Присоединяйтесь к [группе телеграмм](https://t.me/ThirtyLessonsOfJavaScript).

**Задача 30LessonsOfJavaScript** - руководство для начинающих и опытных разработчиков JavaScript. Добро пожаловать в JavaScript. Мне нравится использовать и преподавать JavaScript, и я надеюсь, что вы это сделаете. JavaScript - это язык браузера.
...
Создайте папку на рабочем столе и назовите ее `30LessonsOfJS` или в любом месте и создайте файл **_index.html_** в папке проекта. Затем вставьте следующий код и откройте его в браузере, либо в [Chrome](https://www.google.com/chrome/).

```html
<!DOCTYPE html>
<html>
  <head>
    <title>30LessonsOfScript: Встроенный скрипт</title>
  </head>
  <body>
...
<html>
  <head>
    <title>30LessonsOfScript: Внутренний скрипт</title>
    <script>
...
<html>
  <head>
    <title>30LessonsOfJavaScript: Внешний скрипт</title>
...
Создайте файл _helloworld.js_ в папке 30LessonsOfJS и напишите следующий код.
...
```js
console.log(typeof "Abhilash"); // строка
...
2. Написать ещё один комментарий, который говорит: _welcome to 30LessonsOfJavaScript_
