...
| ----- | :------------------------------------------------------------------------------------------------------------------------------------------------: |
| 01    |                                                                [Giriş](./readMe.md)                                                                |
| 02    |                                              [Veri Tipleri](./02_Lesson_Data_types/02_Lesson_data_types.md)                                              |
| 03    |                           [Boolean, Operatörler, Tarih](./03_Lesson_Booleans_operators_date/03_booleans_operators_date.md)                            |
| 04    |                                              [Koşullar](./04_Lesson_Conditionals/04_Lesson_conditionals.md)                                              |
| 05    |                                                    [Diziler](./05_Lesson_Arrays/05_Lesson_arrays.md)                                                     |
| 06    |                                                     [Döngüler](./06_Lesson_Loops_Donguler/06_Lesson_loops.md)                                                     |
| 07    |                                               [Fonksiyonlar](./07_Lesson_Functions/07_Lesson_functions.md)                                               |
| 08    |                                                   [Nesneler](./08_Lesson_Objects/08_Lesson_objects.md)                                                   |
| 09    |                          [Yüksek Dereceli Fonksiyonlar](./09_Lesson_Higher_order_functions/09_Lesson_higher_order_functions.md)                          |
| 10    |                                       [Setler Ve Haritalar](./10_Lesson_Sets_and_Maps/10_Lesson_Sets_and_Maps.md)                                        |
| 11    |                        [Yıkıcılar Ve Yapıcılar](./11_Lesson_Destructuring_and_spreading/11_Lesson_destructuring_and_spreading.md)                        |
| 12    |                                   [Düzenli İfadeler](./12_Lesson_Regular_expressions/12_Lesson_regular_expressions.md)                                   |
| 13    |                             [Consol Nesne Metodları](./13_Lesson_Console_object_methods/13_Lesson_console_object_methods.md)                             |
| 14    |                                         [Hata Yönetimi](./14_Lesson_Error_handling/14_Lesson_error_handling.md)                                          |
| 15    |                                                   [Sınıflar](./15_Lesson_Classes/15_Lesson_classes.md)                                                   |
| 16    |                                                        [JSON](./16_Lesson_JSON/16_Lesson_json.md)                                                        |
| 17    |                                            [Web Depoları](./17_Lesson_Web_storages/17_Lesson_web_storages.md)                                            |
| 18    |                                                [Promise'ler](./18_Lesson_Promises/18_Lesson_promises.md)                                                 |
| 19    |                                                  [Closure](./19_Lesson_Closures/19_Lesson_closures.md)                                                   |
| 20    |                                   [Temiz Kod Yazımı](./20_Lesson_Writing_clean_codes/20_Lesson_writing_clean_codes.md)                                   |
| 21    |                                                         [DOM](./21_Lesson_DOM/21_Lesson_dom.md)                                                          |
| 22    |                              [Dom Manipülasyonu](./22_Lesson_Manipulating_DOM_object/22_Lesson_manipulating_DOM_object.md)                               |
| 23    |                                     [Olay Tetikleyiciler](./23_Lesson_Event_listeners/23_Lesson_event_listeners.md)                                      |
| 24    |                             [Mini Proje: Güneş Sistemi](./24_Lesson_Project_solar_system/24_Lesson_project_solar_system.md)                              |
| 25    |  [Mini Proje: Dünya Ülkeleri Veri Görselleştirme 1](./25_Lesson_World_countries_data_visualization_1/25_Lesson_world_countries_data_visualization_1.md)  |
| 26    | [Mini Project: Dünya Ülkeleri Veri Görselleştirme 2](./26_Lesson_World_countries_data_visualization_2/26_Lesson_world_countries_data_visualization_2.md) |
| 27    |                              [Mini Proje: Portföy](./27_Lesson_Mini_project_portfolio/27_Lesson_mini_project_portfolio.md)                               |
| 28    |                      [Mini Proje: Liderler Sıralaması](./28_Lesson_Mini_project_leaderboard/28_Lesson_mini_project_leaderboard.md)                       |
| 29    |            [Mini Proje: Animasyon Karakterleri](./29_Lesson_Mini_project_animating_characters/29_Lesson_mini_project_animating_characters.md)            |
| 30    |                                       [Son Proje](./30_Lesson_Mini_project_final/30_Lesson_mini_project_final.md)                                        |
...
[2. Gün >>](./02_Lesson_Data_types/02_Lesson_data_types.md)

![30 Günde JavaScript](../images/Lesson_1_1.png)
...
<html lang="en">
  <head>
    <title>30LessonsOfScript: Satır İçi script</title>
  </head>
  <body>
...
01-Lesson klasörü içindeki _index.html_ dosyasını tarayıcınızda açtığınızda, şu sonucu alıyor olacaksınız:
